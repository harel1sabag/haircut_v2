    ...
    <Container maxWidth="sm" sx={{ mt: 8, mb: 8, fontFamily: 'Heebo, Arial, sans-serif' }}>
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
          <Avatar
            sx={{ bgcolor: '#607d8b', width: 64, height: 64, ml: 2 }}
            src="https://fonts.gstatic.com/s/i/materialiconsoutlined/content_cut/v16/24px.svg"
            alt="Barber"
          />
          <Box>
            <Typography variant="h3" fontWeight={700} gutterBottom sx={{ fontFamily: 'Heebo', color: '#fff', mb: 0 }}>
              ספר - קביעת תור
            </Typography>
            <Typography variant="h6" sx={{ color: '#b0bec5', fontWeight: 400 }}>
